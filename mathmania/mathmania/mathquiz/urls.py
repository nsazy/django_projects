...
urlpatterns = [
    ...
    path('displayAnswers/', views.displayAnswers, name='displayAnswers'),
    path('mathResultsDetails/<str:date>/<str:time>/', views.mathResultsDetails, name='mathResultsDetails'),
